        ...
        <table>
          <thead>
            <tr>
              <th>Advisor</th>
              <th>Daily Avg</th>
              <th>MTD Hrs<br /><span style={{ color: '#95a9c6', fontSize: '7px' }}>Goal 300</span></th>
              <th>Hrs/RO<br /><span style={{ color: '#95a9c6', fontSize: '7px' }}>Goal 1.4</span></th>
              <th>Alignment %<br /><span style={{ color: '#95a9c6', fontSize: '7px' }}>Goal 10%</span></th>
              <th>Tires %<br /><span style={{ color: '#95a9c6', fontSize: '7px' }}>Goal 15%</span></th>
              <th>Valvoline %<br /><span style={{ color: '#95a9c6', fontSize: '7px' }}>Goal 25%</span></th>
              <th>Roh$50 HRS/RO<br /><span style={{ color: '#95a9c6', fontSize: '7px' }}>Goal 1.2</span></th>
              <th>CSI<br /><span style={{ color: '#95a9c6', fontSize: '7px' }}>Goal 920</span></th>
              <th>ASR %<br /><span style={{ color: '#95a9c6', fontSize: '7px' }}>Goal 21%</span></th>
              <th>ELR %<br /><span style={{ color: '#95a9c6', fontSize: '7px' }}>Goal 88%</span></th>
