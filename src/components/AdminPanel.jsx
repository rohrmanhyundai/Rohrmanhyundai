    ...
    try {
      ...
      for (const a of (data.advisors || [])) {
        ...
        const entry = {
          ...
          coupon_amount: parseFloat(a.coupon_labor) || 0,
        ...
        {data.advisors.map((a, idx) => (
          <div className="form-section" key={a.name}>
            ...
            <div className="form-grid">
              ...
              <div className="field"><label title="Coupon Amount — dollar value of coupons used. Pulled automatically from Coupon Labor.">Coupon Amount <span style={{ color: '#64748b', fontWeight: 500, fontSize: 10, marginLeft: 4 }}>(auto)</span></label><input key={`cpa-${a._lastImport || 0}-${a.coupon_labor ?? ''}`} defaultValue={a.coupon_labor ?? ''} disabled /></div>
