...
const ADVISOR_FIELDS = [
  ...
  { key: 'roh50_hrs_ro',    label: "$50 Add'l/RO", type: 'number', decimals: 2 },
  { key: 'roh50_add_rate',  label: '$50 Add Rate', type: 'pct', decimals: 3 },
...
export default function ManagerReports({ users, onBack }) {
  ...
  async function applyBackfill() {
    ...
    try {
      ...
      if (backfillPdfFile) {
        const p = await parseAdvisorSaTotalsPdf(backfillPdfFile);
