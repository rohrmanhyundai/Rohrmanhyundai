                  ...
                  {['👍','❤️','❓'].map(em => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          background: reacted ? 'rgba(110,231,249,0.18)' : 'rgba(255,255,255,0.04)',
                          border: `1px solid ${reacted ? 'rgba(110,231,249,0.45)' : 'rgba(255,255,255,0.08)'}`,
                      ...
                      >
                        <span>{em}</span>
                        {list.length > 0 && <span style={{ fontWeight: 700, fontSize: 10, color: reacted ? '#6ee7f9' : '#94a3b8' }}>{list.length}</span>}
                      </button>
                    );
                  })}
                </div>
