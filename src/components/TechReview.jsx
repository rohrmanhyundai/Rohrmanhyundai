...
export default function TechReview({ onBack, currentUser }) {
  return (
    <div className="adv-page" style={{ display: 'flex', flexDirection: 'column' }}>
      <div className="adv-topbar">
        <div>
          <div className="adv-title">🔧 Technician Reviews</div>
          <div className="adv-sub">Performance Reviews — Technicians</div>
        </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '40px 32px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', color: '#475569' }}>
          ...
          <div style={{ fontWeight: 900, fontSize: 20, color: '#94a3b8', marginBottom: 8 }}>Technician Reviews</div>
